...
from selita.models import Client, Product, Category, Sale, Inventory
from selita.tests.base import SelitaTestCase


class ClientModelTests(SelitaTestCase):
...
class ProductModelTests(SelitaTestCase):
...
class CategoryModelTests(SelitaTestCase):
...
class SaleModelTests(SelitaTestCase):
...
class InventoryModelTests(SelitaTestCase):
