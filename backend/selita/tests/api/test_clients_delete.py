...
from selita.models import Client, Transaction
from selita.constants import TransactionStatus, TransactionType, Currency
...
class ClientDeletionTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.url = lambda pk: f'/selita/delete-client/{pk}'
