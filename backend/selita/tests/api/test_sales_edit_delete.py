...
from selita.models import Sales, Product, Client, Transaction, Payment, Account, Users, Inventory
...
class SaleUpdateDeleteTestCase(TestCase):
    ...
    def test_delete_sale_unpaid(self):
        ...
        # Delete sale
        response = self.client_api.delete(f'/selita/delete-sale/{sale.id}')
